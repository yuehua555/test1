//原始文件位于 https://github.com/yangyxd/flutter_picker/blob/master/lib/Picker.dart
          ...
          child: Container(
            ...
            child:   CupertinoPicker(
              ...
              onSelectedItemChanged: (int index) {
                ...
                setState(() {
                  if (__printDebug) {
                    print('i=' + i.toString() + ' ,index=' + index.toString());
                  }
...
class CustomTrainStationPickerAdapter extends PickerAdapter<int> {
  ...
  @override
  int getMaxLevel() {
    return 3; // 第一列：省，第二列：市，第三列：车站名
  }

  @override
  bool getIsLinkage() {
    return false; // 三列独立，没有级联
  }
