...
import '../lib/pages/train/picker.dart';
import 'dart:convert';
import 'package:flutter/cupertino.dart';
//import 'package:flutter_picker/flutter_picker.dart';
import '../lib/pages/train/station_model.dart';
          ...
          RaisedButton(
              ...
              onPressed: () {
                showModalBottomSheet(
                    context: context, builder: (context) => Pickers());
              })
        ],
      ),
    );
    ...
    getTrainProvCtiy().whenComplete((){
      ...
      provincePicker = CupertinoPicker(
          ...
          onSelectedItemChanged: (position) {
            ...
            print('current cities:' + currentCities.toString());
            ...
            setState(() {
              ...
              count++;
              cityController.animateToItem(count, duration: Duration(microseconds: 20), curve: ElasticInCurve());
